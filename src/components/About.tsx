...
export const About = () => {
  return (
    <section id="about" className="py-28 px-6 bg-black text-center">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-3xl md:text-5xl font-heading font-bold leading-tight mb-10 text-balance">
            CHÚNG TÔI LÀ NHỮNG NGƯỜI <span className="text-accent-gold">SÁNG TẠO</span>, 
            TẬN TÂM VÀ LUÔN ĐỔI MỚI.
          </p>
          <p className="text-lg md:text-xl font-body text-secondary-medium leading-relaxed max-w-2xl mx-auto">
